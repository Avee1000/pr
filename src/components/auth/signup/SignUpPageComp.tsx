...
import { SignUpPageSelector } from "./SignUpSelector";

export function SignUpPageComp() {
    return (
        <div className="grid min-h-screen grid-cols-1 bg-background text-foreground xl:grid-cols-12 w-full">
            ...
            <div className="relative hidden flex-col dark:bg-ink-darker bg-white justify-center items-center overflow-hidden border-l border-muted-foreground/25 p-12 xl:col-span-7 w-full xl:flex xl:p-16">
