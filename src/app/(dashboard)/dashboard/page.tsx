...
export default async function OrdersDashboard() {
  ...
  return (
    <div
      className="dark:bg-ink min-h-screen text-ink dark:white  flex-1 w-auto sm:m-1 sm:rounded-md shadow-[0_0_15px_rgba(0,0,0,0.2)] bg-white"
    >
      ...
      <main className="p-8 max-w-7xl mx-auto">
        ...
        <nav
          ...
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:max-w-7xl mx-auto"
        >
