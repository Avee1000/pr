                  ...
                  <tr>
                    <td align="left" valign="top" style="padding: 16px 32px 32px 32px;">
                        ...
                        <tr>
                          <td style="padding: 20px;">
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                              <tr>
                                <td align="left" valign="middle" style="color: #475569; font-weight: 500; font-size: 13px; padding-bottom: 10px;">Quote Number:</td>
                                <td align="right" valign="middle" style="font-weight: 600; color: #1A1A1A; padding-bottom: 10px; font-size: 13px;">${quoteNumber}</td>
                              </tr>
                              <tr>
                                <td align="left" valign="middle" style="color: #475569; font-weight: 500; font-size: 13px; padding-bottom: 10px;">Total Estimate:</td>
                                <td align="right" valign="middle" style="font-weight: 700; color: #1A1A1A; font-size: 14px; padding-bottom: 10px; font-variant-numeric: tabular-nums;">${amount}</td>
                              </tr>
                              <tr>
                                <td align="left" valign="middle" style="color: #475569; font-weight: 500; font-size: 13px;">Expires In:</td>
                                <td align="right" valign="middle" style="color: #1A1A1A; font-size: 13px;">${expiresAt}</td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                      ...
                      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin-bottom: 28px;">
                        <tr>
                          <td align="center" valign="top">
                            <a href="${quoteUrl}" target="_blank" style="display: inline-block; background-color: #FFC200; color: #1A1A1A; font-family: 'Inter', sans-serif; font-size: 13px; font-weight: 600; text-decoration: none; padding: 14px 32px; border-radius: 8px; box-shadow: 0 3px 6px rgba(255, 74, 60, 0.2); text-align: center;">
                              View & Accept Quote
                            </a>
                          </td>
                        </tr>
